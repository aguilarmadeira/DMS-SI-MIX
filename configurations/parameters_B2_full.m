%% parameters_B2_full.m
%%
%% FROZEN RUN CONFIGURATION -- B2 categorical ablation -- Full.
...
%% Full: maximal one-coordinate categorical neighborhood (all m_i - 1 alternatives per categorical coordinate). dnr_mode is irrelevant on the K block for this variant; kept at 1 only for consistency.
%%
...
poll_variant = 'full';   % explicit for this frozen run config;

%% parameters_B2_cc_static.m
%%
%% FROZEN RUN CONFIGURATION -- B2 categorical ablation -- CC-static (supplementary control).
...
%% CC-static: generates exactly the cc_dnr trials, but the rotation counters are frozen at rho = 0, so the categorical geometry is the static first covering cycle pi^(0). Supplementary control only, not part of the convergence analysis (see dms_si_mix.m, poll_variant case 'cc_static').
%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
dnr_mode    = 1;   % 0=identity | 1=covering_cycles | 2=sobol_rank | 3=affine
poll_variant = 'cc_static';   % explicit for this frozen run config;

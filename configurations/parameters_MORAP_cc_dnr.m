%% parameters_MORAP_cc_dnr.m
%%
%% FROZEN RUN CONFIGURATION -- MORAP-NM exact finite validation -- CC-DNR (proposal).
...
%% CC-DNR: covering-cycles rotation schedule (the proposal).
%%
...
poll_variant = 'cc_dnr';   % explicit for this frozen run config;

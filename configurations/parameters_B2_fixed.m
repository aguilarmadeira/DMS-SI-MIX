%% parameters_B2_fixed.m
%%
%% FROZEN RUN CONFIGURATION -- B2 categorical ablation -- Fixed.
...
%% Fixed: one permanent identity cycle (dnr_mode = 0); rank-one neighborhood exposes only the adjacencies of that fixed cycle.
%%

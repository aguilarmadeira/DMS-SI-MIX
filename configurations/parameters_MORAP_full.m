...
%%
%% FROZEN RUN CONFIGURATION -- MORAP-NM exact finite validation -- Full.
...
%% Full: maximal one-coordinate categorical neighborhood. dnr_mode is irrelevant on the K block for this variant; kept at 1 only for consistency.
%%
